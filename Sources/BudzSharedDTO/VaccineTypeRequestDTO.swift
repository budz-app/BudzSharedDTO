...
public struct VaccineTypeRequestDTO: Codable {
    ...
    public init(vaccineId: UUID, petId: UUID, vaccineName: String, vaccineDescription: String, safeForPuppies: Bool, safeForDogs: Bool, safeForCats: Bool, safeForBirds: Bool, dateOfFirstDose: Date, dateOfLastSecondDose: Date, status: Bool, photoUrl: String? = nil) {
